...
function fetchdata() {
    $.ajax({
        type: 'GET',
        url: `http://localhost:57588/api/AnonymousFacade/SearchFlightByConditions/search?typeName=Departures&flightId=&country=&company=`
        ...
        //let $flight_thead = $("#flightsth").empty();
        //let $flight_tbody = $("#flightstb").empty();
